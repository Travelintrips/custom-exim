...
interface PIBFormStepperProps {
  steps: Step[];
  currentStep: number;
  onStepClick?: (step: number) => void;
}

export function PIBFormStepper({ steps, currentStep, onStepClick }: PIBFormStepperProps) {
  return (
...
export const PIB_FORM_STEPS: Step[] = [
  { id: 1, title: 'Importer Info', description: 'Importer, Supplier & PPJK details' },
  { id: 2, title: 'Transport', description: 'Shipping & port details' },
  { id: 3, title: 'Goods', description: 'Item declarations with tax' },
